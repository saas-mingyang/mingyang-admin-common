...
func (_c *CloudFileTagCreate) SetTenantID(v uint64) *CloudFileTagCreate {
	_c.mutation.SetTenantID(v)
	return _c
}

// SetNillableTenantID sets the "tenant_id" field if the given value is not nil.
func (_c *CloudFileTagCreate) SetNillableTenantID(v *uint64) *CloudFileTagCreate {
	if v != nil {
		_c.SetTenantID(*v)
	}
	return _c
...
func (_c *CloudFileTagCreate) defaults() error {
