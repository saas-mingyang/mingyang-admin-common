...
func (_c *StorageProviderCreate) SetTenantID(v uint64) *StorageProviderCreate {
	_c.mutation.SetTenantID(v)
	return _c
}

// SetNillableTenantID sets the "tenant_id" field if the given value is not nil.
func (_c *StorageProviderCreate) SetNillableTenantID(v *uint64) *StorageProviderCreate {
	if v != nil {
		_c.SetTenantID(*v)
	}
	return _c
