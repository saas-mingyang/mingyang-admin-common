...
func (_c *FileTagCreate) SetTenantID(v uint64) *FileTagCreate {
	_c.mutation.SetTenantID(v)
	return _c
}

// SetNillableTenantID sets the "tenant_id" field if the given value is not nil.
func (_c *FileTagCreate) SetNillableTenantID(v *uint64) *FileTagCreate {
	if v != nil {
		_c.SetTenantID(*v)
	}
	return _c
...
func (_c *FileTagCreate) defaults() error {
