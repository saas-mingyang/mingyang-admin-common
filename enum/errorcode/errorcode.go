...
const (
	...
	//
	// This error code will not be generated by the gRPC framework.
	NotFound int = common.StatusNotFound
	...
	Internal int = common.StatusInternalServerError
	...
	Unavailable int = common.StatusServiceUnavailable
	...
	Unauthenticated int = common.StatusUnauthorized
)
